...
public class MyMusicListAdapter extends BaseAdapter{
    ...
    private ArrayList<Music> mp3Infos;//存放Mp3Info引用的集合
     ...
     * @param mp3Infos  集合对象
     */
    public MyMusicListAdapter(Context ctx, ArrayList<Music> mp3Infos){
        this.ctx = ctx;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        vh.textView3_time.setText(MusicUtils.formatTime(mp3Info.getDuration()));//显示时长

        //获取专辑封面图片
        Bitmap albumBitmapItem = MusicUtils.getArtwork(ctx,mp3Info.getId(),mp3Info.getAlbumId(),true,true);
