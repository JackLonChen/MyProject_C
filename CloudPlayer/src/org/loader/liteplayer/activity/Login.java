...
import org.loader.liteplayer.com.web.WebService;
import org.loader.liteplayer.com.web.WebServicePost;
			...
			handler.post(new Runnable() {
				...
				public void run() {
					...
					if(a == 0)
					{
						...
						infotv.setText(b);
						dialog.dismiss();
						Toast toast = Toast.makeText(Login.this, b, Toast.LENGTH_SHORT);
						toast.setGravity(Gravity.CENTER, 0, 0);
						toast.show();
					}
					if(a == 1) {
						String b = "登录失败，请检查账号密码";
						infotv.setText(b);
						dialog.dismiss();
						Toast toast = Toast.makeText(Login.this, b, Toast.LENGTH_SHORT);
						toast.setGravity(Gravity.CENTER, 0, 0);
