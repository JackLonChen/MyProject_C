...
import org.loader.liteplayer.com.web.RWebService;
...
public class Register extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		r_name = (EditText) findViewById(R.id.user);
		r_password = (EditText) findViewById(R.id.pass);
...
//			}
	...
	public class MyThread implements Runnable {
		@Override
		public void run() {
			info = RWebService.executeHttpGet(r_name.getText().toString(), r_password.getText().toString());
			// info =
			...
			handler.post(new Runnable() {
				...
				public void run() {
					...
					if(a == 0)
					{
						...
						infotv.setText(b);
						dialog.dismiss();
						Toast toast = Toast.makeText(Register.this, b, Toast.LENGTH_SHORT);
						toast.setGravity(Gravity.CENTER, 0, 0);
						toast.show();
					}
					if(a == 1) {
